...
def get_pass(n):
    ...
    passdict.update({14: 1611325212343114105968, 15: 1214114232133124115106978, 16: 1317115262143531341251161079})
    passdict.update({17: 11621531441351261171089, 18: 12151811724272163631545414513612711810})
